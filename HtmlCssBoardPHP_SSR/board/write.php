...
<body>
    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            ...
            <form action="../backend/insertBoard.php" method="post">
                <!-- 2.1 게시글 작성 영역-->
                <div class="board_write">
                    ...
                    <div class="info">
                        <div class="writer">
                            ...
                            <div class="col_input"><input type="text" placeholder="글쓴이 입력" name="writer"></div>
                        </div>
                        <div class="password">
                    ...
                    <!-- 2.1.3 내용 입력 영역 -->
                    <div class="content">
                        <textarea placeholder="내용 입력" name='msg'></textarea>                        
                    </div>
                </div>
                <!-- 2.2 제출(글 저장)/ 취소 버튼영역 -->
                <div class="btn_wrap">
